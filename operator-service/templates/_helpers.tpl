...
{{ include "operator-service.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "operator-service.selectorLabels" -}}
...
*/}}
{{- define "operator-service.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "operator-service.fullname" .) .Values.serviceAccount.name }}
{{- else }}
